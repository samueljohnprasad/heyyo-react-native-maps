    ...
    <G data-name="Layer 2">
      <G data-name="\u2014\xCE\xD3\xC8 1">
        ...
        <Path
          fill="#60350a"
          fillRule="evenodd"
          d="m45.487 19.987-29.173.175s1.048 16.148-2.619 21.21h35.701c-.92-1.35-3.353-1.785-3.909-21.385z"
        />
        <Path
          fill="#d5e1ed"
          fillRule="evenodd"
          d="m18.135 45.599 7.206-3.187 11.55-.3 7.42 3.897-5.357 11.215-7.613 4.088-7.875-4.35-5.331-11.363z"
        />
        <Path
          fill="#f9dca4"
          fillRule="evenodd"
          d="m24.744 38.68 12.931.084v8.949l-12.931-.085V38.68z"
        />
        <Path
          fillRule="evenodd"
        ...
        <Path
          fill="#f9dca4"
          fillRule="evenodd"
          d="M19.11 24.183c-2.958 1.29-.442 7.41 1.42 7.383a30.842 30.842 0 0 1-1.42-7.383zm24.397-.001c2.96 1.292.443 7.411-1.419 7.384a30.832 30.832 0 0 0 1.419-7.384z"
        />
        <Path
          fill="#ffe8be"
          fillRule="evenodd"
