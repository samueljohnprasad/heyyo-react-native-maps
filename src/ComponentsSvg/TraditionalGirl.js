...
const SvgComponent = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.8 62.571" {...props}>
    <Defs>
      <ClipPath id="a">
        <Path
          fill="none"
    ...
    <G data-name="Layer 2">
      <G data-name="\u2014\xCE\xD3\xC8 1">
        ...
        <G clipPath="url(#b)">
          <Path
            fillRule="evenodd"
            d="m37.677 38.778 1.691.851c.04.87.089 4.6.702 5.537-1.807 4.15-14.135 3.408-15.874-6.55z"
            opacity={0.11}
          />
        </G>
        <Path
          fill="#f9dca4"
          fillRule="evenodd"
          d="M19.11 24.183c-2.958 1.29-.442 7.41 1.42 7.383a30.847 30.847 0 0 1-1.42-7.383zm24.397-.001c2.96 1.292.443 7.411-1.419 7.384a30.827 30.827 0 0 0 1.419-7.384z"
        />
        <Path
          fill="#ffe8be"
          fillRule="evenodd"
