...
const SvgComponent = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.8 66.358" {...props}>
    <Defs>
      <ClipPath id="a">
        <Path
          fill="none"
      ...
      <ClipPath id="b">
        <Path
          fill="none"
          d="m14.112 46.496 6.814-3.042 10.209 13.978 10.328-13.938 5.949 2.831v20.033h-33.3V46.496z"
          clipRule="evenodd"
        />
      </ClipPath>
    </Defs>
    <G data-name="Layer 2">
      <G data-name="\u2014\xCE\xD3\xC8 1">
        ...
        <Path
          fill="#f9dca4"
          fillRule="evenodd"
          d="M18.365 24.046c-3.07 1.339-.46 7.686 1.472 7.658a31.972 31.972 0 0 1-1.472-7.659zm25.77 0c3.07 1.339.465 7.686-1.466 7.657a31.978 31.978 0 0 0 1.466-7.657z"
        />
        <Path
          fill="#ecbe6a"
          fillRule="evenodd"
